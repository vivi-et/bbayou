        ...
        <div class="wrapper" style="float: left; margin-left:5%">
          <div class="clash-card barbarian" id="giftcon{{ $giftcon->id }}">
            <div class="clash-card__image clash-card__image--barbarian">
              <div
                style="background-image: url('/storage/giftcon_images/{{ $giftcon->imagepath }}'); width: 100%;
            ...
            <div
              class="clash-card__unit-stats clash-card__unit-stats--giant clearfix"
            >
              <div class="one-third">
...
<script>
      ...
      function makeImage(x){
         ...
         link.download = "<?php echo $giftcon->title.$giftcon->id.now().'.jpg'; ?>";
          link.href = data;
          link.click();
