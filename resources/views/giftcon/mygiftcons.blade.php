        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="text-align: center;">
                    ...
                    <input id="inputGiftconTitle" style="text-align: center;" readonly>
                    <br>
                    <br>
                    {{-- 유저 검색창 --}}
                    <div class="user-input-container" id="user-input-container" style="position: relative;">
                        <input type="search" id="user-search-input" class="user-input-search" placeholder="선물할 사용자를 찾아주세요"
  ...
  autocomplete('#user-search-input', {}, [
      {
        ...
        displayKey: 'name',
        templates: {
          header: '<div class="user-suggestions-category">사용자</div>',
